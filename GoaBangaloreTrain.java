public class GoaBangaloreTrain extends Train {
    public GoaBangaloreTrain(int trainNumber, String trainName, String source, String destination, String arrivalTime,
